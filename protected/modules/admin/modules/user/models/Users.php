...
class Users extends CActiveRecord {
   ...
   public function tableName() {
    ...
    public function rules() {
        ...
        return array(
            array('username', 'required', 'message'=>'Логин не может быть пустым'),
			array('password', 'required', 'message'=>'Пароль не может быть пустым'),
			array('username', 'unique', 'on' => 'insert', 'message'=>'Такой логин уже существует выберите другой логин.'),
            array('user_role__id', 'numerical', 'integerOnly'=>true),
            array('username, email', 'length', 'max'=>128),
            array('password', 'length', 'max'=>64),
            array('id, username, password, email, user_role__id, is_blocked', 'safe', 'on'=>'search'),
        );
    }
    ...
    public function relations() {
        return array(
			...
			'profile' => array(self::HAS_ONE, 'Profile', 'users__id'),
			'deliveries' => array(self::HAS_MANY, 'UsersDeliveries', 'users__id'),
        );
    }
