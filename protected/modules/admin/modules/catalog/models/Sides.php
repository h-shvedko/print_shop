...
class Sides extends CActiveRecord
{
	...
	public function search()
	{
		...
		$criteria->compare('sides',$this->sides,true);
	...
	{
		$model = Sides::model()->findAll('is_visible = :is_visible', array(':is_visible' => (int)TRUE));
		
		$list = array();
		foreach($model as $value)
		{
			$list[$value->id] = $value->sides;
		}
	...
	public function findBySide($side)
	{
		$model = $this->find('sides like :sides', array(':sides' => '%'.$sides.'%'));
